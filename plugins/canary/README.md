...
- **Always exit 0.** Per `wixie/../enchanter-foundations/packages/core/conduct/hooks.md`.
...
|---|---|---|
| Runtime hook (`posttooluse-scan.sh`) | **Advisory only — always exit 0** | `../enchanter-foundations/packages/core/conduct/hooks.md` |
...
per `../enchanter-foundations/packages/core/conduct/hooks.md`.

...
- **Always exit 0.** Per `wixie/shared/foundations/conduct/hooks.md`.
...
|---|---|---|
| Runtime hook (`posttooluse-scan.sh`) | **Advisory only — always exit 0** | `shared/foundations/conduct/hooks.md` |
...
per `shared/foundations/conduct/hooks.md`.

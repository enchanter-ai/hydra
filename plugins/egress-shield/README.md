...
[`../vis/packages/core/conduct/hooks.md`](../../../vis/packages/core/conduct/hooks.md) codifies the
...
`../vis/packages/core/conduct/hooks.md`. Per `wixie/CLAUDE.md`:
...
This is the same fail-open posture `../vis/packages/core/conduct/hooks.md` § Fail-open
...
- `hydra-egress-monitor` — advisory sibling; logs every destination,
  never blocks.
- `../vis/packages/core/conduct/hooks.md` — the contract this plugin overrides.

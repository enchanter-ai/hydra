...
- **Always exits 0.** Hook contract is observe-and-inject, never deny. See `wixie/shared/foundations/conduct/hooks.md`.
...
- **Cache:** `state/cache/<sha1-of-url>.json`, 24-hour mtime TTL, atomic `os.replace` write — per `wixie/shared/foundations/conduct/web-fetch.md`.

...
- **Advisory only** — emits a stderr advisory block (`=== action-guard (advisory) ===` / `Would have blocked: …` / `Hint: …`) and exits 0. Never blocks tool execution. See [`shared/conduct/hooks.md`](../../shared/conduct/hooks.md).

...
`wixie/shared/foundations/conduct/delegation.md` codifies a per-role tool whitelist
...
3. **Always exits 0.** Per `wixie/shared/foundations/conduct/hooks.md`, advisory
   hooks never block.
...
- `wixie/shared/foundations/conduct/hooks.md` — advisory contract (no exit-2).

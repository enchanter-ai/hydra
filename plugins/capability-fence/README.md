...
`wixie/../enchanter-foundations/packages/core/conduct/delegation.md` codifies a per-role tool whitelist
...
3. **Always exits 0.** Per `wixie/../enchanter-foundations/packages/core/conduct/hooks.md`, advisory
   hooks never block.
...
- `wixie/../enchanter-foundations/packages/core/conduct/hooks.md` — advisory contract (no exit-2).

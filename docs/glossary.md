...
Each finding carries a severity. Severities are advisory (per [shared/conduct/hooks.md](../shared/conduct/hooks.md) — hooks inform, never decide), but they shape how the finding is surfaced.
...
The decision to proceed is always the human's or the orchestrator's — see [shared/conduct/hooks.md](../shared/conduct/hooks.md) § Injection over denial.

...
Audience: Claude. Behavioral defaults for any skill that writes or edits code. Orthogonal to the product-specific contracts in root `CLAUDE.md` — this module governs *how the agent acts*, not *what it ships*.

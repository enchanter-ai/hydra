...
All notable changes to `reaper` are documented in this file.
...
[Unreleased]: https://github.com/enchanted-plugins/reaper/compare/v1.0.0...HEAD
[1.0.0]: https://github.com/enchanted-plugins/reaper/releases/tag/v1.0.0

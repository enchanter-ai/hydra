...
- Environments where advisory warnings are insufficient — Hydra's hooks inform, they don't silently block (see [shared/foundations/conduct/hooks.md](shared/foundations/conduct/hooks.md)).
...
Hydra builds on foundations laid by others:

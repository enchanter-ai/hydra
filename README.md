...
- Environments where advisory warnings are insufficient — Hydra's hooks inform, they don't silently block (see [shared/conduct/hooks.md](shared/conduct/hooks.md)).
